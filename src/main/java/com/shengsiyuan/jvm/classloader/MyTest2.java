 ...
 *
 * 助记符 ldc：表示将int、float 或者String类型的常量值从常量池中推送至栈顶
 * 助记符 bipush： 表示将单字节（-128-127）的常量值推送到栈顶
 * 助记符 sipush：表示将一个短整型（-32768-32767）推送到栈顶
 * 助记符 iconst_1：表示将int型的1推送到栈顶（iconst_m1到isonst_5)
 */
public class MyTest2 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(MyParent2.k);
    }
...
class MyParent2 {
    ...
    public static final int k = 3213464;
